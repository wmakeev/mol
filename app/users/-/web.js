...
(function ($) {
    var $mol_app_users = (function (_super) {
        ...
        $mol_app_users.prototype.empty_message = function () {
            return $.$mol_locale.text(this.locale_contexts(), "empty_message");
        };
        $mol_app_users.prototype.Empty = function () {
            var _this = this;
            return (function (obj) {
        ...
        $mol_app_users.prototype.List = function () {
            ...
            return (function (obj) {
                ...
                obj.Empty = function () { return _this.Empty(); };
                return obj;
            })(new $.$mol_list);
        };
        ...
        $mol_app_users.prototype.users_master = function () {
            return null;
        };
        $mol_app_users.prototype.Message = function () {
            var _this = this;
            return (function (obj) {
                obj.status = function () { return _this.users_master(); };
                return obj;
            })(new $.$mol_status);
        };
        ...
        $mol_app_users.prototype.Touch = function () {
            var _this = this;
            return (function (obj) {
                obj.swipe_bottom = function (val) { return _this.event_reload(val); };
                return obj;
            })(new $.$mol_touch);
        };
        $mol_app_users.prototype.plugins = function () {
            return [].concat(this.Touch());
        };
        $mol_app_users.prototype.user_name = function (id, val, force) {
            return (val !== void 0) ? val : "";
        };
        $mol_app_users.prototype.event_user_drop = function (id, val, force) {
            return (val !== void 0) ? val : null;
        };
        $mol_app_users.prototype.User_row = function (id) {
            var _this = this;
            return (function (obj) {
                obj.title = function (val) { return _this.user_name(id, val); };
                obj.event_drop = function (val) { return _this.event_user_drop(id, val); };
                return obj;
...
(function ($) {
    ...
    (function ($mol) {
        var $mol_app_users = (function (_super) {
            ...
            $mol_app_users.prototype.users = function (next, force) {
            ...
            $mol_app_users.prototype.users_master = function (next, force) {
                ...
                if (!master)
                    return [];
                var data = next && { items: next.map(function (login) { return ({ login: login }); }) };
                return master.json(data, force).items.map(function (item) { return item.login; });
            };
            ...
            $mol_app_users.prototype.user_name = function (index, next) {
                var users = this.users();
                if (next !== undefined) {
                    this.users(users.slice(0, index).concat([next], users.slice(index + 1)));
                }
                return users[index] || '';
            };
            __decorate([
