...
(function ($) {
    var $mol_app_habhub = (function (_super) {
        ...
        $mol_app_habhub.prototype.details_scroll_top = function (val, force) {
            return (val !== void 0) ? val : 0;
        };
    ...
    (function ($mol) {
        var $mol_app_habhub = (function (_super) {
            ...
            $mol_app_habhub.prototype.gists = function () {
                return $.$mol_http.resource(this.uriSource()).json().items;
            };
            ...
            $mol_app_habhub.prototype.Placeholder = function () {
                return this.gist_current_id() ? null : _super.prototype.Placeholder.call(this);
            };
            $mol_app_habhub.prototype.menu_rows = function () {
                var _this = this;
