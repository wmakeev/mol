...
(function ($) {
    var $mol_perf_render = (function (_super) {
        ...
        $mol_perf_render.prototype.event_run = function (val, force) {
...
(function ($) {
    var $mol_perf_render_row = (function (_super) {
        ...
        $mol_perf_render_row.prototype.selected = function (val, force) {
        ...
        $mol_perf_render_row.prototype.event_toggle = function (val, force) {
            return (val !== void 0) ? val : null;
        };
    ...
    (function ($mol) {
        var $mol_perf_render = (function (_super) {
            ...
            $mol_perf_render.prototype.Row = function (id) {
                var _this = this;
                return $mol_perf_render_row.make({
                    data: function () { return _this.data()[id]; },
