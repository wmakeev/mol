...
var $;
(function ($) {
    var $mol_perf_sierp = (function (_super) {
        __extends($mol_perf_sierp, _super);
        function $mol_perf_sierp() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $mol_perf_sierp.prototype.size_target = function () {
            return 25;
        };
        $mol_perf_sierp.prototype.elapsed = function (val, force) {
            return (val !== void 0) ? val : 0;
        };
        $mol_perf_sierp.prototype.transform = function () {
            return "";
        };
        $mol_perf_sierp.prototype.style = function () {
            return ({
                "transform": this.transform(),
            });
        };
        $mol_perf_sierp.prototype.left = function (id) {
            return 0;
        };
        $mol_perf_sierp.prototype.top = function (id) {
            return 0;
        };
        $mol_perf_sierp.prototype.size = function (id) {
            return 25;
        };
        $mol_perf_sierp.prototype.text = function () {
            return "";
        };
        $mol_perf_sierp.prototype.Dot = function (id) {
            var _this = this;
            return (function (obj) {
                obj.left = function () { return _this.left(id); };
                obj.top = function () { return _this.top(id); };
                obj.size = function () { return _this.size(id); };
                obj.text = function () { return _this.text(); };
                return obj;
            })(new $.$mol_perf_sierp_dot);
        };
        __decorate([
            $.$mol_mem()
        ...
        return $mol_perf_sierp;
    }($.$mol_view));
    $.$mol_perf_sierp = $mol_perf_sierp;
})($ || ($ = {}));
(function ($) {
    var $mol_perf_sierp_dot = (function (_super) {
        __extends($mol_perf_sierp_dot, _super);
        function $mol_perf_sierp_dot() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        $mol_perf_sierp_dot.prototype.size = function () {
            return 25;
        };
        $mol_perf_sierp_dot.prototype.size_px = function () {
            return "25px";
        };
        $mol_perf_sierp_dot.prototype.hover = function (val, force) {
            return (val !== void 0) ? val : false;
        };
        $mol_perf_sierp_dot.prototype.text = function () {
            return "";
        };
        $mol_perf_sierp_dot.prototype.sub = function () {
            return [].concat(this.text());
        };
        $mol_perf_sierp_dot.prototype.width = function () {
            return this.size();
        };
        $mol_perf_sierp_dot.prototype.height = function () {
            return this.size();
        };
        $mol_perf_sierp_dot.prototype.left = function () {
            return 0;
        };
        $mol_perf_sierp_dot.prototype.top = function () {
            return 0;
        };
        $mol_perf_sierp_dot.prototype.radius = function () {
            return this.size();
        };
        $mol_perf_sierp_dot.prototype.color = function () {
            return "";
        };
        $mol_perf_sierp_dot.prototype.style = function () {
            return ({
                "width": this.width(),
                "height": this.height(),
                "left": this.left(),
        ...
        $mol_perf_sierp_dot.prototype.enter = function (val, force) {
            return (val !== void 0) ? val : null;
        };
        $mol_perf_sierp_dot.prototype.leave = function (val, force) {
            return (val !== void 0) ? val : null;
        };
        $mol_perf_sierp_dot.prototype.event_async = function () {
            var _this = this;
            return ({
                "mouseenter": function (val) { return _this.enter(val); },
                "mouseleave": function (val) { return _this.leave(val); },
            });
        };
        __decorate([
            $.$mol_mem()
...
(function ($) {
    ...
    (function ($mol) {
        var $mol_perf_sierp = (function (_super) {
            ...
            $mol_perf_sierp.prototype.sub = function () {
                var _this = this;
                return this.data().map(function (props, index) { return _this.Dot(index); });
            };
            $mol_perf_sierp.prototype.data = function () {
                return this.SierpinskiTriangle({ left: 0, top: 0, size: 1000 });
            };
            $mol_perf_sierp.prototype.SierpinskiTriangle = function (id) {
                var target = this.size_target();
                if (id.size < target) {
                ...
                return this.SierpinskiTriangle({ left: id.left, top: id.top - size / 2, size: size }).concat(this.SierpinskiTriangle({ left: id.left - size, top: id.top + size / 2, size: size }), this.SierpinskiTriangle({ left: id.left + size, top: id.top + size / 2, size: size }));
            };
            $mol_perf_sierp.prototype.left = function (index) {
                return this.data()[index].left;
            };
            $mol_perf_sierp.prototype.top = function (index) {
                return this.data()[index].top;
            };
            $mol_perf_sierp.prototype.size = function (index) {
            ...
            $mol_perf_sierp.prototype.transform = function () {
                var t = ($.$mol_state_time.now() / 1000) % 10;
        ...
        $mol.$mol_perf_sierp = $mol_perf_sierp;
        var $mol_perf_sierp_dot = (function (_super) {
            __extends($mol_perf_sierp_dot, _super);
            function $mol_perf_sierp_dot() {
                return _super !== null && _super.apply(this, arguments) || this;
            ...
            $mol_perf_sierp_dot.prototype.enter = function (next) {
                this.hover(true);
            };
            $mol_perf_sierp_dot.prototype.leave = function (next) {
                this.hover(false);
            };
            return $mol_perf_sierp_dot;
        }($.$mol_perf_sierp_dot));
        $mol.$mol_perf_sierp_dot = $mol_perf_sierp_dot;
    })($mol = $.$mol || ($.$mol = {}));
})($ || ($ = {}));
//serp.view.js.map
